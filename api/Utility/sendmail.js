...
export const sendActivationLink = async ( to, data  ) => {
    ...
    try {
        ...
        // send activation maill
        await transport.sendMail({
        from : `Facebook pro <${ process.env.MAIL_ID }>`,
        subject : 'facebook activation',
        to : to,
        ...
        <table class="main" style="background-color:#fff;color:rgb(37, 36, 36);width:100%;max-width:600px;margin:0 auto;border-spacing:0;font-family:sans-serif;padding: 20px;">
            ...
            <td class="body-section" style="padding:0;background-color: #fff;">
                ...
                <tr>
                    <td class="message-name" style="padding:0;">
                    <a href="${ data.link }" style="text-decoration:none;"> <button style="padding: 10px; background-color:#2377f2; color:#fff;border: none; outline: none; border-radius: 4px; cursor: pointer;">Confirm Your Account</button></a>
                    </td>
                </tr>
                </table>
            </td>
            ...
            <td class="body-section" style="padding:0;background-color: #fff;">
                ...
                <tr>
                    <td class="message-name" style="padding:0;">
                    <a href="#" style="text-decoration:none;"> <button style="padding: 10px; background-color:#f1f2f4; color:rgb(7, 0, 0);border: none; outline: none; border-radius: 4px; cursor: pointer; font-size: 20px; letter-spacing: 3px;">FB_ ${ data.code }</button></a>
                    </td>
                </tr>
                </table>
            </td>
